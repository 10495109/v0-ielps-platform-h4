          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5">
              <p className="mb-4 text-xs leading-relaxed text-muted-foreground">
                ...
                live EILPS routes, called through the same-origin{' '}
                <code className="rounded bg-muted px-1 py-0.5 font-mono">/api/eilps</code>{' '}
                proxy. GET routes without path parameters hydrate automatically.
              </p>
