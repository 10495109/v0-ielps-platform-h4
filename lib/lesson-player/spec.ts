...
export const LESSON_STEPS: LessonStep[] = [
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/lessons/:id' }],
  ...
  },
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/curriculum/lessons/:id/outcomes' }],
    required: true,
  ...
  },
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/localisation/languages' }],
    required: false,
  ...
  },
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/lessons/:id/vocabulary' }],
    required: true, allowsAudio: true,
  ...
  },
  {
    ...
    endpoints: [
      { method: 'GET', path: '/api/lessons/:id/vocabulary' },
      { method: 'GET', path: '/api/assets/vocabulary/:id' },
    ],
    required: true, allowsAudio: true,
  ...
  },
  {
    ...
    endpoints: [{ method: 'POST', path: '/api/activities/attempts' }],
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/review/results' },
    ],
    required: false,
  ...
  },
  {
    ...
    endpoints: [
      { method: 'GET', path: '/api/lessons/:id/language-focus' },
      { method: 'POST', path: '/api/activities/attempts' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'POST', path: '/api/ai/coach/message' },
      { method: 'POST', path: '/api/pronunciation/assess' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'GET', path: '/api/audio/lesson/:id/manifest' },
      { method: 'POST', path: '/api/pronunciation/assess' },
    ],
  ...
  },
  {
    ...
    endpoints: [{ method: 'POST', path: '/api/writing/attempts' }],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'POST', path: '/api/error-analysis/feedback' },
      { method: 'POST', path: '/api/ai/coach/message' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'POST', path: '/api/assessments/lesson-check' },
      { method: 'POST', path: '/api/ai/coach/message' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'POST', path: '/api/progress/lesson-complete' },
      { method: 'POST', path: '/api/rewards/lesson-complete' },
    ],
    required: true,
