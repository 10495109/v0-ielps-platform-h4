...
export const LESSON_STEPS: LessonStep[] = [
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/curriculum/deep-catalog' }],
  ...
  },
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/curriculum/lessons/:id' }],
    required: true,
  ...
  },
  {
    ...
    endpoints: [{ method: 'GET', path: '/api/resources/starfall-splashlearn/lessons/:id' }],
    required: true, allowsAudio: true,
  ...
  },
  {
    ...
    endpoints: [
      { method: 'GET', path: '/api/resources/starfall-splashlearn/lessons/:id' },
  ...
  },
  {
    ...
    endpoints: [{ method: 'POST', path: '/api/activities/:id/submissions' }],
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/activities/:id/submissions' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'GET', path: '/api/resources/starfall-splashlearn/audio-scripts/:id' },
      { method: 'POST', path: '/api/assessment/pronunciation' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'POST', path: '/api/practice/grade' },
      { method: 'POST', path: '/api/tutor/chat' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      { method: 'POST', path: '/api/assessment/checkpoint/:level/score' },
      { method: 'POST', path: '/api/tutor/chat' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/gamification/profile' },
    ],
    required: true,
